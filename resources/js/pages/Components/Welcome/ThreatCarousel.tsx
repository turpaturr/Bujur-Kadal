        ...
        <section className="mt-20">
            <div className="mb-6 flex items-end justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full border border-[#CCECEE] bg-white dark:bg-card text-foreground transition hover:bg-[#CCECEE]/40"
            ...
            >
                {CAROUSEL_STATS.map((stat) => (
                    <div
                        key={stat.id}
                        className="flex min-w-[280px] shrink-0 snap-center flex-col justify-between rounded-2xl border border-[#CCECEE] bg-white dark:bg-card p-6 sm:min-w-[320px] shadow-xs"
                    >
                        <div>
                            <span className="mb-3 inline-block text-[10px] font-semibold uppercase tracking-[0.18em] text-[#14967F]">
                                {stat.subtitle}
                            </span>
                            <div className="font-display text-3xl font-bold tracking-tight text-[#095D7E] sm:text-4xl">
                                {stat.title}
                            </div>
                        ...
                        <div className="mt-8 flex items-center justify-between border-t border-border/70 pt-4 text-xs text-muted-foreground">
                            ...
                            <span className="font-mono font-semibold text-[#095D7E]">0{stat.id} / 04</span>
                        </div>
                    </div>
                ))}
            </div>
